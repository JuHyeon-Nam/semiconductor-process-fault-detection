...
| Explanation docs | final review, interview notes, semiconductor process notes, portfolio one-pager |
...
- Optional SHAP-based explanations only if dependency setup stays stable
- Lightweight AutoEncoder comparison only if it remains reproducible
- Process-tag mapping if a non-anonymized fab dataset is available
- Final visual review of README and dashboard before submission
